...
import CellMeasurerCache, {
  DEFAULT_HEIGHT,
  DEFAULT_WIDTH,
} from './CellMeasurerCache'; // Accounts for the fact that JSDom doesn't support measurements.
...
function createParent() {
  var _ref2 =
    ...
    invalidateCellSizeAfterRender =
      _ref2$invalidateCellS === void 0 ? jest.fn() : _ref2$invalidateCellS;
...
describe('CellMeasurer', function() {
  ...
  it('should explicitly set width/height style to "auto" before re-measuring', function() {
    ...
    var child = jest.fn().mockReturnValue(
