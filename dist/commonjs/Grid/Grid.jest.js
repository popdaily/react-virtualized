...
describe('Grid', function() {
  ...
  describe('number of rendered children', function() {
    ...
    it('should scroll to the last existing point when rows are removed', function() {
      ...
      var updatedGrid = (0, _TestUtils.render)(
        getMarkup({
          rowCount: 10,
        }),
      );
  ...
  describe('property updates', function() {
    it('should update :scrollToColumn position when :columnWidth changes', function() {
      var grid = (0, _reactDom.findDOMNode)(
        (0, _TestUtils.render)(
          getMarkup({
            scrollToColumn: 25,
          }),
            ...
            case 0:
              ...
              return _regenerator['default'].awrap(
                new Promise(function(resolve) {
                  return setTimeout(
                    resolve,
                    _Grid.DEFAULT_SCROLLING_RESET_TIME_INTERVAL * 2,
                  );
                }),
              );
            ...
            case 0:
              ...
              return _regenerator['default'].awrap(
                new Promise(function(resolve) {
                  return setTimeout(
                    resolve,
                    _Grid.DEFAULT_SCROLLING_RESET_TIME_INTERVAL,
                  );
                }),
              );
        ...
        (function(_React$PureComponent) {
          ...
          function GridComponent() {
            ...
            return (0, _possibleConstructorReturn2['default'])(
              this,
              (0, _getPrototypeOf2['default'])(GridComponent).apply(
                this,
                arguments,
              ),
            );
  ...
  it('should not complain when using react-test-renderer', function() {
    var instance = _reactTestRenderer['default']
      .create(getMarkup())
      .getInstance();
